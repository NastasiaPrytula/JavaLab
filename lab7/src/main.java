...
class ServerConnectionThread extends Thread {
    ...
    public void run() {
        System.out.println("Waiting message from client... (" + this + ")");
    ...
    public String toString() {
        return "Client: " + this.socket.getInetAddress().toString() + " port:" +this.socket.getPort() + " connected:" + this.connected;
    }
...
class Server {
    ...
    Server(int port) {
        System.out.println("Run server: " + port);
    ...
    public void onClientMessage(ServerConnectionThread clientThread, String message) {
        System.out.println("Message from (" + clientThread + "): " + message);
...
class ClientConnectionThread extends Thread {
    ...
    public void run() {
        try {
            System.out.println("Connected to server... "+this.client.server_address+" port:"+this.client.server_port);
